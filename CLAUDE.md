...
This is an Astro and Tailwind CSS theme. When editing code:
...
- Use `CustomButton.astro`, `Icons.astro`, and `OptimizedImage.astro` instead of rebuilding shared primitives.
